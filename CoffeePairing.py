...
# INSTRUCTIONS ON HOW TO DOWNLOAD THE CSV FILE FROM THE GOOGLE FORM
...
# MAKE SURE THE CSV IS DOWNLOADED AGAIN IF NEW PARTICIPANTS ARE ADDED TO THE LIST
...
# POSSIBILITY TO STOP THE PROGRAM IF THE INSTRUCTIONS ABOVE ARE NOT COMPLETED
start = input("If you have completed the steps above type 'start', otherwise type 'stop'. ")
print("------------------------\n")

if start == "start":
    
    # IMPLEMENT NEW CSV FILE 
    # (IMPORT FROM INTERNET, NON WORKING)
    ...
    # IMPORT A RANDOM CONVERSATION STARTER
    ...
    # (FROM DOWNLOADED CSV, WORKING)
    participants_csv = "Coffee meeting form.csv" 
    ...
    # IMPLEMENT USER INPUT GROUP SIZE AND RANDOM ASSIGNMENT
    max_group_size = 13
    min_group_size = 2
    ...
    if not End:
        ...
        # MSG TO GROUP IN ONE TXT FILE; INCLUDING CONVERSATION STARTER
    ...
    print("Program stopped, make sure you follow all the instructions properly and run the program again.")    
